...
class ConectSqlServer:
    ...
    def get_engine_pyodbc(self, database):
        ...
        connectionString = 'DRIVER={'+f'{use_driver}'+'};'+f'SERVER={SERVER};DATABASE={DATABASE};UID={USERNAME};PWD={PASSWORD};TrustServerCertificate=yes'
